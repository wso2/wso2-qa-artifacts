...
CreateRESTService.jmx - Creates a REST service in Governance Registry. User must update User Defined Variables prior to the execution. Update the conter Start parameter for each execution, otherwise it will try to create duplicate artifacts.

CreateWSDL.jmx - Creates a WSDL artifact in Governance Registry. User must update User Defined Variables prior to the execution. 'ID' variable adds the prefix for created filename. Update the conter 'Start' parameter for each execution, otherwise it will try to create duplicate artifacts.
