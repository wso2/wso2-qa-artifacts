...
public class ts_EndpointManagement extends SeleniumTestBase {
    ...
    /**
     * Test case tc_Advanced_Option_Verification.
     *
     * @throws Exception the exception
     */
    @VTAFRecoveryMethods(onerrorMethods = {}, recoveryMethods = {})
    @Test
    public final void tc_Advanced_Option_Verification() throws Exception {
    } 
    	

    /**
     * Test case tc_Endpoint_Security.
     *
     * @throws Exception the exception
     */
    @VTAFRecoveryMethods(onerrorMethods = {}, recoveryMethods = {})
    @Test
    public final void tc_Endpoint_Security() throws Exception {
    } 
