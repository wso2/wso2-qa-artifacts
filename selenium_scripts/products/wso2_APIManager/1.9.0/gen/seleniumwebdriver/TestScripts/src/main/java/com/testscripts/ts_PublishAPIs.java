...
public class ts_PublishAPIs extends SeleniumTestBase {
    ...
    /**
     * Test case tc_To_Multiple_Gateways.
     *
     * @throws Exception the exception
     */
    @VTAFRecoveryMethods(onerrorMethods = {}, recoveryMethods = {})
    @Test
    public final void tc_To_Multiple_Gateways() throws Exception {
    } 
    	

    /**
     * Test case tc_Sample_API_Verification.
     *
     * @throws Exception the exception
     */
    @VTAFRecoveryMethods(onerrorMethods = {}, recoveryMethods = {})
    @Test
    public final void tc_Sample_API_Verification() throws Exception {
    } 
    	

    /**
     * Test case tc_To_External_UserStores.
     *
     * @throws Exception the exception
     */
    @VTAFRecoveryMethods(onerrorMethods = {}, recoveryMethods = {})
    @Test
    public final void tc_To_External_UserStores() throws Exception {
    } 
