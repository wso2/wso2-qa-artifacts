...
public class ts_WorkflowIntegration extends SeleniumTestBase {
    ...
    /**
     * Test case tc_Application_Registration.
     *
     * @throws Exception the exception
     */
    @VTAFRecoveryMethods(onerrorMethods = {}, recoveryMethods = {})
    @Test
    public final void tc_Application_Registration() throws Exception {
    } 
    	

    /**
     * Test case tc_APICreation.
     *
     * @throws Exception the exception
     */
    @VTAFRecoveryMethods(onerrorMethods = {}, recoveryMethods = {})
    @Test
    public final void tc_APICreation() throws Exception {
    } 
    	

    /**
     * Test case tc_UserSignup.
     *
     * @throws Exception the exception
     */
    @VTAFRecoveryMethods(onerrorMethods = {}, recoveryMethods = {})
    @Test
    public final void tc_UserSignup() throws Exception {
    } 
