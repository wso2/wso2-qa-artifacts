...
public class ts_ErrorHandling extends SeleniumTestBase {
    ...
    public Object[][] dataTable_tc_ErrorHandling() {     	
    	return this.getDataTable("PauseTimes","URLs","ErrorHandling");
    }
