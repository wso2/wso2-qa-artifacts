...
public class ts_Community_Features extends SeleniumTestBase {
    ...
    public final void tc_Forums(final String Common_superAdminUserName, final String Common_superAdminPassword, final String Common_carbonURL, final String Common_PublisherURL, final String Common_storeURL, final String SelfSignUp_userName, final String SelfSignUp_password, final String SelfSignUp_firstName, final String SelfSignUp_lastName, final String SelfSignUp_email, final String SelfSignUp_serverName, final String SelfSignUp_pauseFourSeconds, final String SelfSignUp_pauseSixSeconds, final String Forums_serverName, final String Forums_userNameAdmin, final String Forums_passwordAdmin, final String Forums_topicSubject, final String Forums_topicDescription, final String Forums_storeOneOfAdmin, final String Forums_storeTwoOfAdmin, final String Forums_topicSubjectAdminUser, final String Forums_topicDescriptionAdminUser, final String Forums_topicSubject1, final String Forums_topicDescription1, final String Forums_topicSubject2, final String Forums_topicDescription2, final String Forums_topicSubject3, final String Forums_topicDescription3, final String Forums_replyContentEdit, final String Forums_replyMessageBody, final String Forums_rateStarLevelFour, final String Forums_rateStarLevelTwo, final String Forums_sixSeconds) throws Exception {	
    	writeToReport("Start Executing tc_Forums.");
    	lib_TestCase.APIM_774(this, Forums_userNameAdmin,Forums_passwordAdmin,Forums_topicSubject,Forums_topicDescription,Common_storeURL,Forums_serverName,Forums_sixSeconds,Forums_sixSeconds,Forums_sixSeconds);
    	lib_TestCase.APIM_775(this, Forums_storeOneOfAdmin,Common_storeURL,Forums_topicSubjectAdminUser,Forums_topicDescriptionAdminUser,Forums_serverName,Forums_sixSeconds,Forums_sixSeconds,Forums_sixSeconds);
    	lib_TestCase.APIM_776(this, Common_storeURL,Forums_storeOneOfAdmin,Forums_topicDescription1,Forums_topicDescription2,Forums_topicDescription3,Forums_serverName,Forums_sixSeconds,Forums_sixSeconds,Forums_sixSeconds);
    	lib_TestCase.APIM_780(this, Forums_replyMessageBody,Common_storeURL,Forums_serverName,Forums_serverName,Forums_sixSeconds);
    	lib_TestCase.APIM_781(this, Common_storeURL,Forums_replyMessageBody,Forums_serverName,Forums_sixSeconds);
    	lib_TestCase.APIM_782(this, Forums_storeOneOfAdmin,Forums_serverName,Forums_replyContentEdit,Common_storeURL,Forums_sixSeconds);
    	lib_TestCase.APIM_783(this, Common_storeURL,Forums_serverName,Forums_storeOneOfAdmin,Forums_sixSeconds);
    	lib_TestCase.APIM_784(this, Common_storeURL,Forums_serverName,Forums_storeTwoOfAdmin,Forums_rateStarLevelFour,Forums_rateStarLevelFour,Forums_rateStarLevelTwo,Forums_rateStarLevelTwo,Forums_sixSeconds,Forums_sixSeconds,Forums_sixSeconds,Forums_sixSeconds);
    	lib_TestCase.APIM2_786(this, Common_storeURL,Forums_serverName,Forums_storeTwoOfAdmin,Common_superAdminUserName,Common_superAdminPassword,Forums_storeOneOfAdmin,Forums_replyMessageBody,Forums_sixSeconds);
    ...
    public Object[][] dataTable_tc_Comments() {     	
    	return this.getDataTable("URLs","Common","Comments","PauseTimes");
    }
    ...
    public final void tc_Comments(final String URLs_carbonURL, final String URLs_publisherURL, final String URLs_storeURL, final String Common_superAdminUserName, final String Common_superAdminPassword, final String Common_carbonURL, final String Common_PublisherURL, final String Common_storeURL, final String Comments_APIName, final String Comments_APIContext, final String Comments_APITag, final String Comments_Description, final String Comments_URLPattern, final String Comments_verbMethodGET, final String Comments_ProductionEndPontJaxRS, final String Comments_Comments, final String Comments_tenantOrAdminStoreOne, final String Comments_tenantOrAdminPublisherOne, final String Comments_serverNameDomainOne, final String PauseTimes_oneSecond, final String PauseTimes_twoSeconds, final String PauseTimes_threeSeconds, final String PauseTimes_fourSeconds, final String PauseTimes_fiveSeconds, final String PauseTimes_sixSeconds, final String PauseTimes_sevenSeconds, final String PauseTimes_eightSeconds, final String PauseTimes_nineSeconds, final String PauseTimes_tenSeconds, final String PauseTimes_elevenSeconds, final String PauseTimes_twelveSeconds, final String PauseTimes_thirteenSeconds, final String PauseTimes_fourteenSeconds, final String PauseTimes_fifteenSeconds) throws Exception {	
    	...
    	lib_Common.bc_PublisherLogin(this, URLs_publisherURL,Comments_tenantOrAdminPublisherOne,PauseTimes_threeSeconds,PauseTimes_fourSeconds);
    	lib_TestCase.APIM2_788(this, Comments_APIName,Comments_APIContext,Comments_APITag,Comments_Description,Comments_URLPattern,Comments_verbMethodGET,Comments_ProductionEndPontJaxRS,Comments_Comments,Comments_tenantOrAdminStoreOne,Comments_tenantOrAdminPublisherOne,Comments_serverNameDomainOne,URLs_storeURL,PauseTimes_sixSeconds,PauseTimes_threeSeconds,PauseTimes_fourSeconds,PauseTimes_eightSeconds);
    	lib_TestCase.APIM2_789(this, URLs_storeURL,Comments_serverNameDomainOne,PauseTimes_sixSeconds);
    ...
    public Object[][] dataTable_tc_Ratings() {     	
    	return this.getDataTable("URLs","Common","Ratings","PauseTimes");
    }
